...
public class JDialogSuaSanPham extends javax.swing.JDialog {
     ...
     public void setHeader(String headerText) {
        // Cập nhật trực tiếp lên component giao diện
        head.setText(headerText);

        // Kiểm tra điều kiện một cách an toàn để tránh NullPointerException
        if ("Xem sản phẩm".equals(headerText)) {
    ...
    private void initComponents() {
        ...
        btnAction.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(btnAction, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
